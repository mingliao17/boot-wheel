package com.example.boot_backstage_management.common;

/**
 * @Author: mingliao17
 * @CreateTime: 2019/11/18 22:22
...
public class SnowIdUtils {
    ...
    private static class SnowFlake {
        ...
        /**
         * 起始的时间戳-2019-11-18 22:43:30
         */
        private final long START_TIMESTAMP = 1574088210000L;
        /**
         * 序列号占用位数
         */
     ...
     * 获取String类型雪花ID
     */
    public static String getUniqueLongHex() {
        return String.format("%016x", getUniqueLong());
    }
